...
new #[Layout('components.layouts.fe')] class extends Component {
    ...
    public function store(): void
    {
        ...
        try {
            ...
            $this->success('Your order has been sent.', position: 'toast-bottom');
            $this->reset('customer_name', 'cart', 'drawerCart');
...
<div>
    ...
    <x-drawer wire:model="drawerCart" title="Cart" class="w-11/12 lg:w-1/3" without-trap-focus right>
        ...
        <div class="divide-y" id='cart-items' wire:ignore >
        ...
        <x-slot:actions>
            <div x-data="{ show: false }" x-effect="show = $wire.cart.length > 0">
                ...
                <x-button x-show="show" label="Order" responsive icon="fas.check" @click="$wire.store" spinner="store" class="btn-primary" />
            </div>
